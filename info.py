...
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '-1002410637061').split()]
USERNAME = environ.get('USERNAME', "https://t.me/MovieKingHubSupportbot") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002361565292'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Moviekinghubs')
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'ammumanu')
#---------------------------------------------------------------
#---------------------------------------------------------------
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/MovieKingHubSupportbot') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
